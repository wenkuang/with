...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'buzz' => 'getBuzzService',
            'buzz.browser.gitonomy' => 'getBuzz_Browser_GitonomyService',
            'buzz.browser_manager' => 'getBuzz_BrowserManagerService',
            'buzz.client.gitonomy' => 'getBuzz_Client_GitonomyService',
            'buzz.listener.exception_listener' => 'getBuzz_Listener_ExceptionListenerService',
            'buzz.listener.history' => 'getBuzz_Listener_HistoryService',
            'buzz.listener.history_journal' => 'getBuzz_Listener_HistoryJournalService',
            'buzz.listener.host_gitonomy' => 'getBuzz_Listener_HostGitonomyService',
            'buzz.message_factory.gitonomy' => 'getBuzz_MessageFactory_GitonomyService',
            ...
            'gitonomy_core.config' => 'getGitonomyCore_ConfigService',
            'gitonomy_core.event_dispatcher' => 'getGitonomyCore_EventDispatcherService',
            'gitonomy_core.git.hook_injector' => 'getGitonomyCore_Git_HookInjectorService',
            'gitonomy_core.git.repository_pool' => 'getGitonomyCore_Git_RepositoryPoolService',
            'gitonomy_core.git.shell_handler' => 'getGitonomyCore_Git_ShellHandlerService',
            'gitonomy_core.listener.config' => 'getGitonomyCore_Listener_ConfigService',
            'gitonomy_core.listener.feed' => 'getGitonomyCore_Listener_FeedService',
            'gitonomy_core.listener.project_permissions' => 'getGitonomyCore_Listener_ProjectPermissionsService',
            'gitonomy_core.mailer' => 'getGitonomyCore_MailerService',
            'gitonomy_core.mailer.data_collector' => 'getGitonomyCore_Mailer_DataCollectorService',
            'gitonomy_core.validation.new_email' => 'getGitonomyCore_Validation_NewEmailService',
            'gitonomy_core.validator.unique' => 'getGitonomyCore_Validator_UniqueService',
            'gitonomy_distribution.form.installation_step_doctrine' => 'getGitonomyDistribution_Form_InstallationStepDoctrineService',
            'gitonomy_distribution.form.installation_step_secret' => 'getGitonomyDistribution_Form_InstallationStepSecretService',
            'gitonomy_distribution.steps' => 'getGitonomyDistribution_StepsService',
            'gitonomy_twig.git.data_collector' => 'getGitonomyTwig_Git_DataCollectorService',
            'gitonomy_website.buzz.browser.gitonomy' => 'getGitonomyWebsite_Buzz_Browser_GitonomyService',
            'gitonomy_website.form.type.administration_config' => 'getGitonomyWebsite_Form_Type_AdministrationConfigService',
            'gitonomy_website.form.type.administration_role' => 'getGitonomyWebsite_Form_Type_AdministrationRoleService',
            'gitonomy_website.form.type.administration_user' => 'getGitonomyWebsite_Form_Type_AdministrationUserService',
            'gitonomy_website.form.type.change_password' => 'getGitonomyWebsite_Form_Type_ChangePasswordService',
            'gitonomy_website.form.type.gitonomy_locale' => 'getGitonomyWebsite_Form_Type_GitonomyLocaleService',
            'gitonomy_website.form.type.profile_email' => 'getGitonomyWebsite_Form_Type_ProfileEmailService',
            'gitonomy_website.form.type.profile_information' => 'getGitonomyWebsite_Form_Type_ProfileInformationService',
            'gitonomy_website.form.type.profile_password' => 'getGitonomyWebsite_Form_Type_ProfilePasswordService',
            'gitonomy_website.form.type.profile_ssh_key' => 'getGitonomyWebsite_Form_Type_ProfileSshKeyService',
            'gitonomy_website.form.type.project' => 'getGitonomyWebsite_Form_Type_ProjectService',
            'gitonomy_website.form.type.project_git_access' => 'getGitonomyWebsite_Form_Type_ProjectGitAccessService',
            'gitonomy_website.form.type.project_role' => 'getGitonomyWebsite_Form_Type_ProjectRoleService',
            'gitonomy_website.form.type.splash_login' => 'getGitonomyWebsite_Form_Type_SplashLoginService',
            'gitonomy_website.form.type.splash_register' => 'getGitonomyWebsite_Form_Type_SplashRegisterService',
            'gitonomy_website.form.type.user_password' => 'getGitonomyWebsite_Form_Type_UserPasswordService',
            'gitonomy_website.twig.gitonomy' => 'getGitonomyWebsite_Twig_GitonomyService',
            ...
            'security.user.provider.concrete.entity' => 'getSecurity_User_Provider_Concrete_EntityService',
        ...
        $this->aliases = array(
            ...
            'gitonomy.mailer' => 'gitonomy_core.mailer',
            'repository_pool' => 'gitonomy_core.git.repository_pool',
     ...
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Bundle\BuzzBundle\Buzz\Buzz A Buzz\Bundle\BuzzBundle\Buzz\Buzz instance.
     */
    protected function getBuzzService()
    {
        return $this->services['buzz'] = new \Buzz\Bundle\BuzzBundle\Buzz\Buzz($this->get('buzz.browser_manager'));
    }

    /**
     * Gets the 'buzz.browser.gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBuzz_Browser_GitonomyService()
    {
        $this->services['buzz.browser.gitonomy'] = $instance = new \Buzz\Browser($this->get('buzz.client.gitonomy'), $this->get('buzz.message_factory.gitonomy'));

        $instance->addListener($this->get('buzz.listener.host_gitonomy'));
        $instance->addListener($this->get('buzz.listener.exception_listener'));
        $instance->addListener($this->get('buzz.listener.history'));

        return $instance;
    }

    /**
     * Gets the 'buzz.browser_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Bundle\BuzzBundle\Buzz\BrowserManager A Buzz\Bundle\BuzzBundle\Buzz\BrowserManager instance.
     */
    protected function getBuzz_BrowserManagerService()
    {
        $this->services['buzz.browser_manager'] = $instance = new \Buzz\Bundle\BuzzBundle\Buzz\BrowserManager();

        $instance->set('gitonomy', $this->get('buzz.browser.gitonomy'));
        $instance->set('gitonomy', $this->get('gitonomy_website.buzz.browser.gitonomy'));

        return $instance;
    }

    /**
     * Gets the 'buzz.client.gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBuzz_Client_GitonomyService()
    {
        $this->services['buzz.client.gitonomy'] = $instance = new \Buzz\Client\Curl();
    ...
    /**
     * Gets the 'buzz.listener.exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Bundle\BuzzBundle\Buzz\Listener\ExceptionListener A Buzz\Bundle\BuzzBundle\Buzz\Listener\ExceptionListener instance.
     */
    protected function getBuzz_Listener_ExceptionListenerService()
    {
        return $this->services['buzz.listener.exception_listener'] = new \Buzz\Bundle\BuzzBundle\Buzz\Listener\ExceptionListener();
    }

    /**
     * Gets the 'buzz.listener.history' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Listener\HistoryListener A Buzz\Listener\HistoryListener instance.
     */
    protected function getBuzz_Listener_HistoryService()
    {
        return $this->services['buzz.listener.history'] = new \Buzz\Listener\HistoryListener($this->get('buzz.listener.history_journal'));
    }

    /**
     * Gets the 'buzz.listener.history_journal' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Listener\History\Journal A Buzz\Listener\History\Journal instance.
     */
    protected function getBuzz_Listener_HistoryJournalService()
    {
        return $this->services['buzz.listener.history_journal'] = new \Buzz\Listener\History\Journal();
    }

    /**
     * Gets the 'buzz.listener.host_gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Buzz\Bundle\BuzzBundle\Buzz\Listener\HostListener A Buzz\Bundle\BuzzBundle\Buzz\Listener\HostListener instance.
     */
    protected function getBuzz_Listener_HostGitonomyService()
    {
        return $this->services['buzz.listener.host_gitonomy'] = new \Buzz\Bundle\BuzzBundle\Buzz\Listener\HostListener('http://gitonomy.com');
    }

    /**
     * Gets the 'buzz.message_factory.gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Component\Buzz\Message\Factory\JsonMessageFactory A Gitonomy\Component\Buzz\Message\Factory\JsonMessageFactory instance.
     */
    protected function getBuzz_MessageFactory_GitonomyService()
    {
        return $this->services['buzz.message_factory.gitonomy'] = new \Gitonomy\Component\Buzz\Message\Factory\JsonMessageFactory();
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('gitonomy_core.listener.config', 'Gitonomy\\Bundle\\CoreBundle\\Listener\\ConfigListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \Gitonomy\Bundle\CoreBundle\Doctrine\ProjectSubscriber($this->get('gitonomy_core.git.repository_pool')));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'gitonomy', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->addDriver($d, 'Gitonomy\\Bundle\\CoreBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('GitonomyCoreBundle' => 'Gitonomy\\Bundle\\CoreBundle\\Entity'));
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'button' => 'form.type.button', 'submit' => 'form.type.submit', 'reset' => 'form.type.reset', 'currency' => 'form.type.currency', 'entity' => 'form.type.entity', 'gitonomy_locale' => 'gitonomy_website.form.type.gitonomy_locale', 'register' => 'gitonomy_website.form.type.splash_register', 'login' => 'gitonomy_website.form.type.splash_login', 'change_password' => 'gitonomy_website.form.type.change_password', 'project' => 'gitonomy_website.form.type.project', 'project_role' => 'gitonomy_website.form.type.project_role', 'project_git_access' => 'gitonomy_website.form.type.project_git_access', 'profile_information' => 'gitonomy_website.form.type.profile_information', 'profile_email' => 'gitonomy_website.form.type.profile_email', 'profile_ssh_key' => 'gitonomy_website.form.type.profile_ssh_key', 'profile_password' => 'gitonomy_website.form.type.profile_password', 'user_password' => 'gitonomy_website.form.type.user_password', 'administration_config' => 'gitonomy_website.form.type.administration_config', 'administration_user' => 'gitonomy_website.form.type.administration_user', 'administration_role' => 'gitonomy_website.form.type.administration_role', 'installation_step_doctrine' => 'gitonomy_distribution.form.installation_step_doctrine', 'installation_step_secret' => 'gitonomy_distribution.form.installation_step_secret'), array('form' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.csrf', 3 => 'form.type_extension.form.data_collector'), 'repeated' => array(0 => 'form.type_extension.repeated.validator'), 'submit' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    /**
     * Gets the 'gitonomy_core.config' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Component\Config\ChainConfig A Gitonomy\Component\Config\ChainConfig instance.
     */
    ...
    /**
     * Gets the 'gitonomy_core.event_dispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGitonomyCore_EventDispatcherService()
    {
        $this->services['gitonomy_core.event_dispatcher'] = $instance = new \Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher($this);

        $instance->addSubscriberService('gitonomy_core.listener.feed', 'Gitonomy\\Bundle\\CoreBundle\\Listener\\FeedListener');
        $instance->addSubscriberService('gitonomy_core.listener.project_permissions', 'Gitonomy\\Bundle\\CoreBundle\\Listener\\ProjectPermissionsListener');
        $instance->addSubscriberService('gitonomy_core.git.repository_pool', 'Gitonomy\\Bundle\\CoreBundle\\Debug\\DebugRepositoryPool');
        $instance->addListenerService('gitonomy.project_create', array(0 => 'gitonomy_core.git.hook_injector', 1 => 'onProjectCreate'), 0);

        return $instance;
    }

    /**
     * Gets the 'gitonomy_core.git.hook_injector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Git\HookInjector A Gitonomy\Bundle\CoreBundle\Git\HookInjector instance.
     */
    ...
    /**
     * Gets the 'gitonomy_core.git.repository_pool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Debug\DebugRepositoryPool A Gitonomy\Bundle\CoreBundle\Debug\DebugRepositoryPool instance.
     */
    ...
    /**
     * Gets the 'gitonomy_core.git.shell_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Git\ShellHandler A Gitonomy\Bundle\CoreBundle\Git\ShellHandler instance.
     */
    protected function getGitonomyCore_Git_ShellHandlerService()
    {
        return $this->services['gitonomy_core.git.shell_handler'] = new \Gitonomy\Bundle\CoreBundle\Git\ShellHandler();
    }

    /**
     * Gets the 'gitonomy_core.listener.config' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Listener\ConfigListener A Gitonomy\Bundle\CoreBundle\Listener\ConfigListener instance.
     */
    protected function getGitonomyCore_Listener_ConfigService()
    {
        return $this->services['gitonomy_core.listener.config'] = new \Gitonomy\Bundle\CoreBundle\Listener\ConfigListener($this);
    }

    /**
     * Gets the 'gitonomy_core.listener.feed' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Listener\FeedListener A Gitonomy\Bundle\CoreBundle\Listener\FeedListener instance.
     */
    protected function getGitonomyCore_Listener_FeedService()
    {
        return $this->services['gitonomy_core.listener.feed'] = new \Gitonomy\Bundle\CoreBundle\Listener\FeedListener($this->get('doctrine'), $this->get('gitonomy_core.git.repository_pool'));
    }

    /**
     * Gets the 'gitonomy_core.listener.project_permissions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Listener\ProjectPermissionsListener A Gitonomy\Bundle\CoreBundle\Listener\ProjectPermissionsListener instance.
     */
    protected function getGitonomyCore_Listener_ProjectPermissionsService()
    {
        return $this->services['gitonomy_core.listener.project_permissions'] = new \Gitonomy\Bundle\CoreBundle\Listener\ProjectPermissionsListener($this->get('doctrine'));
    }

    /**
     * Gets the 'gitonomy_core.mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Mailer\DebugMailer A Gitonomy\Bundle\CoreBundle\Mailer\DebugMailer instance.
     */
    protected function getGitonomyCore_MailerService()
    {
        return $this->services['gitonomy_core.mailer'] = new \Gitonomy\Bundle\CoreBundle\Mailer\DebugMailer($this);
    }

    /**
     * Gets the 'gitonomy_core.mailer.data_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Debug\MailerDataCollector A Gitonomy\Bundle\CoreBundle\Debug\MailerDataCollector instance.
     */
    protected function getGitonomyCore_Mailer_DataCollectorService()
    {
        return $this->services['gitonomy_core.mailer.data_collector'] = new \Gitonomy\Bundle\CoreBundle\Debug\MailerDataCollector($this->get('gitonomy_core.mailer'));
    }

    /**
     * Gets the 'gitonomy_core.validation.new_email' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Validation\Constraints\NewEmailValidator A Gitonomy\Bundle\CoreBundle\Validation\Constraints\NewEmailValidator instance.
     */
    protected function getGitonomyCore_Validation_NewEmailService()
    {
        return $this->services['gitonomy_core.validation.new_email'] = new \Gitonomy\Bundle\CoreBundle\Validation\Constraints\NewEmailValidator($this->get('doctrine'));
    }

    /**
     * Gets the 'gitonomy_core.validator.unique' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Validator\Constraints\UniqueValidator A Gitonomy\Bundle\CoreBundle\Validator\Constraints\UniqueValidator instance.
     */
    protected function getGitonomyCore_Validator_UniqueService()
    {
        return $this->services['gitonomy_core.validator.unique'] = new \Gitonomy\Bundle\CoreBundle\Validator\Constraints\UniqueValidator($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'gitonomy_distribution.form.installation_step_doctrine' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationDoctrineStepType A Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationDoctrineStepType instance.
     */
    protected function getGitonomyDistribution_Form_InstallationStepDoctrineService()
    {
        return $this->services['gitonomy_distribution.form.installation_step_doctrine'] = new \Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationDoctrineStepType();
    }

    /**
     * Gets the 'gitonomy_distribution.form.installation_step_secret' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationSecretStepType A Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationSecretStepType instance.
     */
    protected function getGitonomyDistribution_Form_InstallationStepSecretService()
    {
        return $this->services['gitonomy_distribution.form.installation_step_secret'] = new \Gitonomy\Bundle\DistributionBundle\Form\Type\InstallationSecretStepType();
    }

    /**
     * Gets the 'gitonomy_distribution.steps' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\DistributionBundle\Installation\StepList A Gitonomy\Bundle\DistributionBundle\Installation\StepList instance.
     */
    protected function getGitonomyDistribution_StepsService()
    {
        return $this->services['gitonomy_distribution.steps'] = new \Gitonomy\Bundle\DistributionBundle\Installation\StepList(array(0 => new \Gitonomy\Bundle\DistributionBundle\Installation\Step\DoctrineStep(), 1 => new \Gitonomy\Bundle\DistributionBundle\Installation\Step\SecretStep()));
    }

    /**
     * Gets the 'gitonomy_twig.git.data_collector' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\GitBundle\DataCollector\GitDataCollector A Gitonomy\Bundle\GitBundle\DataCollector\GitDataCollector instance.
     */
    protected function getGitonomyTwig_Git_DataCollectorService()
    {
        return $this->services['gitonomy_twig.git.data_collector'] = new \Gitonomy\Bundle\GitBundle\DataCollector\GitDataCollector();
    }

    /**
     * Gets the 'gitonomy_website.buzz.browser.gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Component\Buzz\Browser\GitonomyBrowser A Gitonomy\Component\Buzz\Browser\GitonomyBrowser instance.
     */
    protected function getGitonomyWebsite_Buzz_Browser_GitonomyService()
    {
        $this->services['gitonomy_website.buzz.browser.gitonomy'] = $instance = new \Gitonomy\Component\Buzz\Browser\GitonomyBrowser($this->get('buzz.client.gitonomy'), $this->get('buzz.message_factory.gitonomy'));

        $instance->setCurrentVersion('0.4-DEV');
        $instance->addListener($this->get('buzz.listener.host_gitonomy'));
        $instance->addListener($this->get('buzz.listener.exception_listener'));
        $instance->addListener($this->get('buzz.listener.history'));
    ...
    /**
     * Gets the 'gitonomy_website.form.type.administration_config' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Administration\ConfigType A Gitonomy\Bundle\WebsiteBundle\Form\Administration\ConfigType instance.
     */
    protected function getGitonomyWebsite_Form_Type_AdministrationConfigService()
    {
        return $this->services['gitonomy_website.form.type.administration_config'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Administration\ConfigType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.administration_role' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Administration\RoleType A Gitonomy\Bundle\WebsiteBundle\Form\Administration\RoleType instance.
     */
    protected function getGitonomyWebsite_Form_Type_AdministrationRoleService()
    {
        return $this->services['gitonomy_website.form.type.administration_role'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Administration\RoleType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.administration_user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Administration\UserType A Gitonomy\Bundle\WebsiteBundle\Form\Administration\UserType instance.
     */
    protected function getGitonomyWebsite_Form_Type_AdministrationUserService()
    {
        return $this->services['gitonomy_website.form.type.administration_user'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Administration\UserType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.change_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Splash\ChangePasswordType A Gitonomy\Bundle\WebsiteBundle\Form\Splash\ChangePasswordType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ChangePasswordService()
    {
        return $this->services['gitonomy_website.form.type.change_password'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Splash\ChangePasswordType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.gitonomy_locale' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\LocaleType A Gitonomy\Bundle\WebsiteBundle\Form\LocaleType instance.
     */
    protected function getGitonomyWebsite_Form_Type_GitonomyLocaleService()
    {
        return $this->services['gitonomy_website.form.type.gitonomy_locale'] = new \Gitonomy\Bundle\WebsiteBundle\Form\LocaleType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.profile_email' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Profile\EmailType A Gitonomy\Bundle\WebsiteBundle\Form\Profile\EmailType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProfileEmailService()
    {
        return $this->services['gitonomy_website.form.type.profile_email'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Profile\EmailType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.profile_information' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Profile\InformationType A Gitonomy\Bundle\WebsiteBundle\Form\Profile\InformationType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProfileInformationService()
    {
        return $this->services['gitonomy_website.form.type.profile_information'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Profile\InformationType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.profile_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Profile\ProfilePasswordType A Gitonomy\Bundle\WebsiteBundle\Form\Profile\ProfilePasswordType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProfilePasswordService()
    {
        return $this->services['gitonomy_website.form.type.profile_password'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Profile\ProfilePasswordType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.profile_ssh_key' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Profile\SshKeyType A Gitonomy\Bundle\WebsiteBundle\Form\Profile\SshKeyType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProfileSshKeyService()
    {
        return $this->services['gitonomy_website.form.type.profile_ssh_key'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Profile\SshKeyType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.project' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Project\ProjectType A Gitonomy\Bundle\WebsiteBundle\Form\Project\ProjectType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProjectService()
    {
        return $this->services['gitonomy_website.form.type.project'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Project\ProjectType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.project_git_access' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Project\GitAccessType A Gitonomy\Bundle\WebsiteBundle\Form\Project\GitAccessType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProjectGitAccessService()
    {
        return $this->services['gitonomy_website.form.type.project_git_access'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Project\GitAccessType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.project_role' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Project\RoleType A Gitonomy\Bundle\WebsiteBundle\Form\Project\RoleType instance.
     */
    protected function getGitonomyWebsite_Form_Type_ProjectRoleService()
    {
        return $this->services['gitonomy_website.form.type.project_role'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Project\RoleType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.splash_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Splash\LoginType A Gitonomy\Bundle\WebsiteBundle\Form\Splash\LoginType instance.
     */
    protected function getGitonomyWebsite_Form_Type_SplashLoginService()
    {
        return $this->services['gitonomy_website.form.type.splash_login'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Splash\LoginType();
    }

    /**
     * Gets the 'gitonomy_website.form.type.splash_register' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\Splash\RegisterType A Gitonomy\Bundle\WebsiteBundle\Form\Splash\RegisterType instance.
     */
    protected function getGitonomyWebsite_Form_Type_SplashRegisterService()
    {
        return $this->services['gitonomy_website.form.type.splash_register'] = new \Gitonomy\Bundle\WebsiteBundle\Form\Splash\RegisterType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.form.type.user_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Form\User\UserPasswordType A Gitonomy\Bundle\WebsiteBundle\Form\User\UserPasswordType instance.
     */
    protected function getGitonomyWebsite_Form_Type_UserPasswordService()
    {
        return $this->services['gitonomy_website.form.type.user_password'] = new \Gitonomy\Bundle\WebsiteBundle\Form\User\UserPasswordType($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'gitonomy_website.twig.gitonomy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\WebsiteBundle\Twig\GitonomyExtension A Gitonomy\Bundle\WebsiteBundle\Twig\GitonomyExtension instance.
     */
    protected function getGitonomyWebsite_Twig_GitonomyService()
    {
        return $this->services['gitonomy_website.twig.gitonomy'] = new \Gitonomy\Bundle\WebsiteBundle\Twig\GitonomyExtension($this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add($d);
        $instance->add(new \Buzz\Bundle\BuzzBundle\DataCollector\BuzzDataCollector($this->get('buzz.listener.history')));
        $instance->add($this->get('gitonomy_core.mailer.data_collector'));
        $instance->add($this->get('gitonomy_twig.git.data_collector'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Gitonomy\\Bundle\\CoreBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.entity');
        ...
        $j = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'splash_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'splash_logout'));
        $k->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $k->addHandler($j);

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($i, array('login_path' => 'splash_login', 'default_target_path' => 'splash_login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
     ...
     * This method always returns the same instance of the service.
     *
     * @return Gitonomy\Bundle\CoreBundle\Templating\TimedTwigEngine A Gitonomy\Bundle\CoreBundle\Templating\TimedTwigEngine instance.
     */
    protected function getTemplatingService()
    {
        $this->services['templating'] = $instance = new \Gitonomy\Bundle\CoreBundle\Templating\TimedTwigEngine($this->get('twig'), $this->get('templating.name_parser'), $this->get('templating.locator'), $this->get('debug.stopwatch'), $this->get('templating.globals'));
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('main', 'splash_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'GitonomyWebsiteBundle::form.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'AsseticBundle', 5 => 'DoctrineBundle', 6 => 'DoctrineFixturesBundle', 7 => 'BuzzBundle', 8 => 'GitonomyCoreBundle', 9 => 'GitonomyWebsiteBundle', 10 => 'GitonomyGitBundle', 11 => 'SensioDistributionBundle', 12 => 'WebProfilerBundle', 13 => 'GitonomyDistributionBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('gitonomy_website.twig.gitonomy'));
        $instance->addExtension(new \Gitonomy\Bundle\GitBundle\Twig\GitExtension(new \Gitonomy\Bundle\GitBundle\Routing\GitUrlGenerator($a, array('commit' => 'project_commit', 'branch' => 'project_history', 'tag' => 'project_history', 'tree' => 'project_tree'), array('commit_repository' => 'slug', 'commit_hash' => 'hash', 'branch_repository' => 'slug', 'branch_name' => 'branch', 'tag_repository' => 'slug', 'tag_name' => 'branch', 'tree_repository' => 'slug', 'tree_revision' => 'revision', 'tree_path' => 'path')), array(0 => 'GitonomyGitBundle::default_theme.html.twig')));
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'new_email' => 'gitonomy_core.validation.new_email', 'unique' => 'gitonomy_core.validator.unique')), $this->get('translator.default'), 'validators', array(0 => $this->get('doctrine.orm.validator_initializer')));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Gitonomy\Bundle\CoreBundle\Security\GitAccessVoter(), 1 => new \Gitonomy\Bundle\CoreBundle\Security\ProjectRoleVoter(), 2 => new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter(new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage(), $a, $b), 3 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($b), 4 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($a)), 'affirmative', false, true);
    }
    ...
    {
        return $this->services['security.user.provider.concrete.entity'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Gitonomy\\Bundle\\CoreBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BuzzBundle' => 'Buzz\\Bundle\\BuzzBundle\\BuzzBundle',
                'GitonomyCoreBundle' => 'Gitonomy\\Bundle\\CoreBundle\\GitonomyCoreBundle',
                'GitonomyWebsiteBundle' => 'Gitonomy\\Bundle\\WebsiteBundle\\GitonomyWebsiteBundle',
                'GitonomyGitBundle' => 'Gitonomy\\Bundle\\GitBundle\\GitonomyGitBundle',
                'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle',
                'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle',
                'GitonomyDistributionBundle' => 'Gitonomy\\Bundle\\DistributionBundle\\GitonomyDistributionBundle',
            ),
            ...
            'templating.engine.twig.class' => 'Gitonomy\\Bundle\\CoreBundle\\Templating\\TwigEngine',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'GitonomyWebsiteBundle::form.html.twig',
            ),
            'debug.templating.engine.twig.class' => 'Gitonomy\\Bundle\\CoreBundle\\Templating\\TimedTwigEngine',
            'twig.options' => array(
                'debug' => true,
            ...
            'assetic.bundles' => array(
                ...
                7 => 'BuzzBundle',
                8 => 'GitonomyCoreBundle',
                9 => 'GitonomyWebsiteBundle',
                10 => 'GitonomyGitBundle',
                11 => 'SensioDistributionBundle',
                12 => 'WebProfilerBundle',
                13 => 'GitonomyDistributionBundle',
            ),
            ...
            'buzz.client.multi_curl.class' => 'Buzz\\Client\\MultiCurl',
            'buzz.client.file_get_contents.class' => 'Buzz\\Client\\FileGetContents',
            'buzz.listener.history.class' => 'Buzz\\Listener\\HistoryListener',
            'buzz.listener.history_journal.class' => 'Buzz\\Listener\\History\\Journal',
            'buzz.data_collector.class' => 'Buzz\\Bundle\\BuzzBundle\\DataCollector\\BuzzDataCollector',
            'buzz' => array(
                'browsers' => array(
                    'gitonomy' => array(
                        'client' => array(
                ...
                'listeners' => array(
                    'exception_listener' => array(
                        'id' => 'buzz.listener.exception_listener',
                    ),
                ),
            ),
            'gitonomy_core.config.chain.class' => 'Gitonomy\\Component\\Config\\ChainConfig',
            'gitonomy_core.config.mysql.class' => 'Gitonomy\\Component\\Config\\MysqlConfig',
            'gitonomy_core.config.php_file.class' => 'Gitonomy\\Component\\Config\\PhpFileConfig',
            'gitonomy_core.config.array.class' => 'Gitonomy\\Component\\Config\\ArrayConfig',
            'gitonomy_core.event_dispatcher.class' => 'Symfony\\Component\\EventDispatcher\\ContainerAwareEventDispatcher',
            'gitonomy_core.listener.feed.class' => 'Gitonomy\\Bundle\\CoreBundle\\Listener\\FeedListener',
            'gitonomy_core.listener.config.class' => 'Gitonomy\\Bundle\\CoreBundle\\Listener\\ConfigListener',
            'gitonomy_core.listener.project_permissions.class' => 'Gitonomy\\Bundle\\CoreBundle\\Listener\\ProjectPermissionsListener',
            'gitonomy_website.doctrine.project_subscriber.class' => 'Gitonomy\\Bundle\\CoreBundle\\Doctrine\\ProjectSubscriber',
            ...
            'gitonomy_core.git.data_collector.class' => 'Gitonomy\\Bundle\\CoreBundle\\Debug\\GitDataCollector',
            'gitonomy_core.mailer.data_collector.class' => 'Gitonomy\\Bundle\\CoreBundle\\Debug\\MailerDataCollector',
            'gitonomy_website.buzz.browser.gitonomy.class' => 'Gitonomy\\Component\\Buzz\\Browser\\GitonomyBrowser',
            'gitonomy_website.form.type.gitonomy_locale.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\LocaleType',
            'gitonomy_website.form.type.splash_register.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Splash\\RegisterType',
            'gitonomy_website.form.type.splash_login.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Splash\\LoginType',
            'gitonomy_website.form.type.change_password.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Splash\\ChangePasswordType',
            'gitonomy_website.form.type.project.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Project\\ProjectType',
            'gitonomy_website.form.type.project_role.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Project\\RoleType',
            'gitonomy_website.form.type.project_git_access.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Project\\GitAccessType',
            'gitonomy_website.form.type.profile_information.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Profile\\InformationType',
            'gitonomy_website.form.type.profile_email.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Profile\\EmailType',
            'gitonomy_website.form.type.profile_ssh_key.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Profile\\SshKeyType',
            'gitonomy_website.form.type.profile_password.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Profile\\ProfilePasswordType',
            'gitonomy_website.form.type.user_password.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\User\\UserPasswordType',
            'gitonomy_website.form.type.administration_config.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Administration\\ConfigType',
            'gitonomy_website.form.type.administration_user.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Administration\\UserType',
            'gitonomy_website.form.type.administration_role.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Form\\Administration\\RoleType',
            'gitonomy_website.twig.gitonomy.class' => 'Gitonomy\\Bundle\\WebsiteBundle\\Twig\\GitonomyExtension',
            'gitonomy_twig.git.data_collector.class' => 'Gitonomy\\Bundle\\GitBundle\\DataCollector\\GitDataCollector',
            'gitonomy_twig.url_generator.class' => 'Gitonomy\\Bundle\\GitBundle\\Routing\\GitUrlGenerator',
            'gitonomy_twig.twig.gitonomy.class' => 'Gitonomy\\Bundle\\GitBundle\\Twig\\GitExtension',
            'gitonomy_twig.themes' => array(
                0 => 'GitonomyGitBundle::default_theme.html.twig',
            ),
            'gitonomy_twig.url_generator.routes_names' => array(
                'commit' => 'project_commit',
                'branch' => 'project_history',
                'tag' => 'project_history',
                'tree' => 'project_tree',
            ),
            'gitonomy_twig.url_generator.routes_args' => array(
            ...
            'data_collector.templates' => array(
                ...
                'buzz.data_collector' => array(
                    0 => 'buzz',
                    1 => 'BuzzBundle:Collector:buzz',
                ),
                'gitonomy_core.mailer.data_collector' => NULL,
                'gitonomy_twig.git.data_collector' => array(
                    0 => 'git',
                    1 => 'GitonomyGitBundle:Profiler:git.html.twig',
                ),
            ),
